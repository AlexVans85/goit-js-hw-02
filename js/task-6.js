...
// показывай alert с текстом 'Было введено не число, попробуйте еще раз', при этом результат prompt записывать в массив чисел не нужно, 
...
// input = prompt('VVEDITE CISLO')


// if (input === null) {
//      alert('spasibo, dosvidania')
// } else  if (input !== null) {
...
while (true) {
    ...
    if (input === null){
        ...
        alert(`Ссума введеных чисел равна: ${total}`)
        break
    }     
